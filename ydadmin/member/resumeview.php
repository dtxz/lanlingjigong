...
.STYLE4 {font-size: 12px; color: #5D9ED9; }
.lrbtline tr td{ padding-left:5px;}
-->
</style>
</head>
<body>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="td_content"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="25">⊙当前位置：技工会员管理 -&gt; <span class="STYLE3"><?php echo $row['xingming']?></span>的简历信息</td>
	...
	<table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" class="lrbtline" style="border-collapse:collapse;border:1px solid #5d9ed9">
			...
			<tr>
		      ...
		      <?php if($row['wkstatus']==0){echo "待岗";}else if($row['wkstatus']==1){echo "在岗";}?>
			  </span></td>
	    </tr>
			<tr>
