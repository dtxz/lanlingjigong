...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="td_content"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="25">⊙当前位置：系统设置-&gt;链接管理-&gt;链接列表</td>
            ...
            <form action="" method="post" id="cmsfrm" name="cmsfrm">
              <tr>
				...
				?>
                      ...
                      <input type="button" name="Submit2" value="添加链接"  onclick="window.location='edit.php?action=add';" class="button"/>&nbsp;<input type="button" name="Submit2" value="链接分类"  onclick="window.location='../linkstype/list.php';" class="button"/>
	...
	if ($act=="search")
	{
		$csql.="select * from `".PRE."links` where `advname`<>''";
		if ($keyword!="")
		{
	...
	$link->link_list($csql,$pagesize,$urlparam);
	?>
