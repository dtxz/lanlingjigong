...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="td_content"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="25">⊙当前位置：系统设置-&gt; 城市管理-&gt;城市编辑</td>
        <td align="right" >&nbsp;</td>
      </tr>
    </table>
	...
	<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" class="lrbtline">
		   ...
		   <tr class="onrow">
			...
			<tr>
					<td width="116" align="right" class="outrow">站点地址：</td>
					<td class="outrow"><input name="weburl" type="text" id="weburl" style="width: 250px;" /></td>
			</tr>
 			<tr  id="div_video">
			...
			<tr>
			  <td height="26" align="right" class="outrow">是否推荐：</td>
			  <td class="outrow"><input name="recommand" type="radio" class="NoBorder" id="radio" value="1" onclick="return false;" onmouseup="this.checked=!this.checked" />
推荐 
  <input name="recommand" type="radio" class="NoBorder" id="radio" onclick="return false;" onmouseup="this.checked=!this.checked" value="0" checked="checked" /> 
不推荐
</td>
			  </tr>
			<tr>
			  <td height="26" align="right" class="outrow">推荐排序：</td>
			  <td class="outrow"><input name="recommandsort" type="text" id="recommandsort"  value="1" size="5" /></td>
			  </tr>
			<tr>
		...
		$sql="select * from `".PRE."city` where `id`=".$func->safe_check($_GET['id'],0);
		$rs=$db->query($sql);
	...
	<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" class="lrbtline">
		   ...
		   <tr class="onrow">
			...
			<select name="fid" id="fid">
              <option value="0">请选择分类</option>
              <?php $city->cityselect("├─",0,trim($row["fid"]));?>    
            </select>
			</td>
            </tr>
			<tr>
			...
			<tr>
					<td width="116" align="right" class="outrow">站点地址：</td>
					<td class="outrow"><input name="weburl" type="text" id="weburl" style="width: 250px;" value="<?php echo $row['weburl']?>"/></td>
			</tr>
 			<tr  >
			  <td align="right" class="outrow">类别排序：</td>
			...
			<tr>
			  <td height="26" align="right" class="outrow">是否推荐：</td>
			  <td class="outrow"><input name="recommand" type="radio" class="NoBorder" id="radio" value="1"   <?php if ($row['recommand']==1){echo "checked";}?> />
推荐 
  <input name="recommand" type="radio" class="NoBorder" id="radio"  value="0"   <?php if ($row['recommand']==0){echo "checked";}?>/> 
不推荐
</td>
			  </tr>
			<tr>
			  <td height="26" align="right" class="outrow">推荐排序：</td>
			  <td class="outrow"><input name="recommandsort" type="text" id="recommandsort"   value="<?php  echo $row['recommandsort']?>" size="5" /></td>
			  </tr>
			<tr>
