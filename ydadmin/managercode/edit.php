...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="td_content"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="25">⊙当前位置：系统设置-&gt; 权限组选项-&gt;选项编辑</td>
        <td align="right" >&nbsp;</td>
      </tr>
    </table>
	...
	<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" class="lrbtline">
		   ...
		   <tr class="onrow">
            <td align="right" class="outrow">所属选项：</td>
            <td class="outrow"><select name="fid" id="fid">
              <option value="0">顶级选项</option>
			  <?php $manager->admincodeselect("├─",0,$fid);?>
            </select></td>
            </tr>
			<tr>
					<td width="116" align="right" class="outrow">选项名称：</td>
					<td class="outrow"><input name="typename" type="text" id="typename" style="width: 250px;" maxlength="60" /></td>
			</tr>

 			<tr  id="div_video">
 			  <td align="right" class="outrow">选项代码：</td>
 			  <td class="outrow"><input name="itemcode" type="text" id="itemcode" style="width: 250px;" maxlength="60" /></td>
 			  </tr>
 			<tr  id="div_video">
			  <td align="right" class="outrow">选项排序：</td>
		...
		$sql="select * from `".PRE."admincode` where `id`=".$func->safe_check($_GET['id'],0);
		$rs=$db->query($sql);
	...
	<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" class="lrbtline">
		   ...
		   <tr class="onrow">
			...
			<select name="fid" id="fid">
              <option value="0">顶级选项</option>
              <?php $manager->admincodeselect("├─",0,trim($row["fid"]));?>    
            </select>			</td>
            </tr>
			<tr>
					<td width="117" align="right" class="outrow">选项名称：</td>
					<td class="outrow"><input name="typename" type="text" id="typename" maxlength="60"  value="<?php echo $row['typename']?>"/></td>
			</tr>
 			<tr  id="div_video">
 			  <td align="right" class="outrow">选项代码：</td>
 			  <td class="outrow"><input name="itemcode" type="text" id="itemcode" style="width: 250px;" maxlength="60"   value="<?php echo $row['itemcode']?>"/></td>
 			  </tr>
 			<tr  >
			  <td align="right" class="outrow">选项排序：</td>
