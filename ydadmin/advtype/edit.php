...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="td_content"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="25">⊙当前位置：系统设置-&gt;广告管理-&gt; 广告类别-&gt;类别编辑</td>
        <td align="right" >&nbsp;</td>
      </tr>
    </table>
	...
	<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" class="lrbtline">
			...
			<tr>
					...
					<td class="outrow"><input name="typename" type="text" id="typename" style="width: 350px;" maxlength="60" /></td>
			</tr>
 			<tr>
			  <td align="right" class="outrow">广告大小：</td>
			  <td class="outrow">宽：<input name="width" type="text" id="width"  value="0" size="5" />像素   高：<input name="height" type="text" id="height"  value="0" size="5" />像素</td>
			  </tr>
 			<tr>
		...
		$sql="select * from `".PRE."advtype` where `id`=".$func->safe_check($_GET['id'],0);
		$rs=$db->query($sql);
	...
	<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" class="lrbtline">
			...
			<tr>
					...
					<td class="outrow"><input name="typename" type="text" id="typename" style="width: 350px;" maxlength="60"  value="<?php echo $row['typename']?>"/></td>
			</tr>
 			<tr>
			  <td align="right" class="outrow">广告大小：</td>
			  <td class="outrow">宽：<input name="width" type="text" id="width"  value="<?php  echo $row['width']?>" size="5" />像素   高：<input name="height" type="text" id="height"  value="<?php  echo $row['height']?>" size="5" />像素</td>
			  </tr>
 			<tr  >
