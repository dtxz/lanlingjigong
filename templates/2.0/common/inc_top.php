...
<div style="box-shadow: 0px 2px 3px rgba(0,0,0,0.1);z-index: 1;position:relative; background-color:#fff;" id="pc_nav">
  <div class="redesign-header"> 
    ...
    <div class="ver1-navigation">  
      ...
      <!--登录前状态-->
      <div class="intersection"><?php if ($session_uid!=""){?><a href="/user" class="inter-log">管理中心</a> 
	  ...
	  <?php }else{?><span style="float:left;"><a href="/user/login.php" class="inter-log">立即登陆</a></span><span style="float:left;"><a href="/user/register.php" class="inter-reg">免费注册</a></span><?php }?></div>
      <!--登录前状态end--> 
