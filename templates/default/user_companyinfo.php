  ...
  <div class="nav-tabs-custom">
	<ul class="nav nav-tabs">
	  <li class="active"><a href="#xgzl" data-toggle="tab">企业信息</a></li>
	   <li style="float:right"><p style="line-height:36px; color:#ff0000; padding:0 10px;">注：以下带<span class="red">*</span>的信息为必填项目,填写完整后通过网站管理员认证后,才可进行查看技工简历信息和发布项目及招聘信息。</span></li>
	</ul>
