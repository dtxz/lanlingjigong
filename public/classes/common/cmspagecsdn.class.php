...
class cmspagecsdn{
	...
	function cmspageshow(){
		...
		if ($lastpage>1){
			$show="<div class=page  align=center>当前第<span class=font12redb>".$this->page."</span>页　共<span class=font12redb>".$this->totle."</span>条记录　共<span class=font12redb>".$lastpage."</span>页　每页显示<span class=font12redb>".$this->pagesize."</span>条&nbsp;";
